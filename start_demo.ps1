...
# 1. Start Origin Website (Port 3000)
Write-Host "[1/3] Starting Origin Website..."
Start-Process powershell -WorkingDirectory $CurrentDir -ArgumentList "-NoExit", "-Command", "python run_website.py"
...
Start-Process "http://localhost:8080"      # The Protected Site
